  ...
  return [
    ...
    { label: () => t('baseRoleManage.dataScope'), prop: 'data_scope',
      ...
      cellRender: ({ row }) => {
        ...
        return (
          <ElTag type={dictStore.t('role-dataScope', row.data_scope, 'color') || undefined}>
            {i18nKey ? t(i18nKey) : ''}
          </ElTag>
        )
      },
        ...
        actions: [
          {
            ...
            onClick: ({ row }) => {
              drawer.setTitle(t('baseRoleManage.setPermission'))
              drawer.open({ formType: 'setPermission', data: row })
            },
          },
          {
            name: 'edit',
