...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('attachment', static function (Blueprint $table) {
            ...
            $table->string('asset_type', 32)->nullable()->comment('资源类型:character=人物,prop=道具,scene=场景,costume=服装,creature=生物,vehicle=载具,bgm=背景音乐,chinese_song=中文歌,english_song=英文歌,japanese_song=日文歌,voice=语音');
            ...
            $table->unsignedTinyInteger('source')->default(0)->comment('来源:0=系统AI生成,1=用户上传');
            $table->bigInteger('created_by')->unsigned()->nullable()->comment('创建者');
            $table->bigInteger('updated_by')->unsigned()->nullable()->comment('更新者');
            $table->timestamps();
