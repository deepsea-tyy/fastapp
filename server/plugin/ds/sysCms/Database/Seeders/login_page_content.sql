-- Login页面内容数据
-- 根据 app/lib/presentation/views/user/login.dart 分析生成

-- 页面标题
INSERT INTO `app_page_content` (`code`, `page_code`, `component_code`, `content_type`, `data`, `platform`, `fixed`, `status`, `sort`, `remark`, `created_at`, `updated_at`) VALUES
