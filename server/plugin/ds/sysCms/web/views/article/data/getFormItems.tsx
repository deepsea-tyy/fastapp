    ...
    return [
        ...
        },
        {
            ...
            renderProps: {
                clearable: true,
                data: lang(t),
                placeholder: t('form.pleaseSelect', {msg: t('common.language')}),
            },
            itemProps: {
                rules: [{required: true, message: t('form.pleaseSelect', {msg: t('common.language')})}],
            },
            cols: { lg: 12, md: 24 },
        },
        {
            ...
            itemProps: {
                rules: [{required: true, message: t('form.pleaseInput', {msg: t('article.ArticleFields.title')})}],
            },
            cols: { lg: 12, md: 24 },
        },
        {
        ...
        },
        {
            ...
            render: () => <ma-editor/>,
            renderProps: {
                placeholder: t('form.pleaseInput', {msg: t('article.ArticleFields.content')}),
            },
            itemProps: {
                rules: [{required: true, message: t('form.pleaseInput', {msg: t('article.ArticleFields.content')})}],
            },
        },
    ]
}
