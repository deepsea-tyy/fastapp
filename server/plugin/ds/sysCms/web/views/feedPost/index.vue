...
import { deleteByIds, page } from '$/ds/syscms/api/feedPost.ts'
...
defineOptions({ name: 'ds:syscms:feed_post' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['ds:syscms:feed_post:create']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['ds:syscms:feed_post:delete']"
          type="danger"
          plain
