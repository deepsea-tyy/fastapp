...
import { deleteByIds, page } from '$/ds/syscms/api/feedTag.ts'
...
defineOptions({ name: 'ds:syscms:feed_tag' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['ds:syscms:feed_tag:create']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['ds:syscms:feed_tag:delete']"
          type="danger"
          plain
