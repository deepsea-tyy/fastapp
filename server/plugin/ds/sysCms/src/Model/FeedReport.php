 ...
 * @property int $target_type 目标类型：1帖子 2文章 3评论
...
class FeedReport extends Model
{
     ...
     */
    protected array $fillable = ['id', 'user_id', 'target_type', 'target_id', 'report_type', 'content', 'handle_status', 'handled_at', 'created_at', 'updated_at'];
