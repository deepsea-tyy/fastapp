...
import sysPageBar from '$/ds/sysConfig/components/sysPageBar.vue'
import sysCopyText from '$/ds/sysConfig/components/sysCopyText.vue'
import emptyImage from '$/ds/sysConfig/assets/empty.svg'
...
.crontab_box{
  ...
  background-image: url("$/ds/sysConfig/assets/bg.png");
