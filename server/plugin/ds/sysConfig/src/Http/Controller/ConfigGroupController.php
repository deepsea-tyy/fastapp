...
use Plugin\Ds\SysConfig\Http\Request\ConfigGroupRequest as Request;
use Plugin\Ds\SysConfig\Service\ConfigGroupService as Service;
...
final class ConfigGroupController extends AbstractController
{
    ...
    #[Permission(code: 'ds:sysConfigGroup:list')]
    ...
    #[Permission(code: 'ds:sysConfigGroup:index:create')]
    ...
    #[Permission(code: 'ds:sysConfigGroup:update')]
    #[Middleware(middleware: OperationMiddleware::class, priority: 98)]
    ...
    #[Permission(code: 'ds:sysConfigGroup:delete')]
    #[Middleware(middleware: OperationMiddleware::class, priority: 98)]
