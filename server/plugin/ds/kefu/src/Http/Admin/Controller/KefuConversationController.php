...
final class KefuConversationController extends AbstractController
{
    ...
    #[GetMapping(path: '/admin/kefu/kefuConversation/list')]
    ...
    #[GetMapping(path: '/admin/kefu/kefuConversation/message')]
    #[Permission(code: 'kefu:kefuConversation:index')]
    ...
    #[GetMapping(path: '/admin/kefu/kefuConversation/chatTree')]
    #[Permission(code: 'kefu:kefuConversation:index')]
    ...
    #[GetMapping(path: '/admin/kefu/kefuConversation/messageVisitor')]
    #[Permission(code: 'kefu:kefuConversation:index')]
    ...
    #[GetMapping(path: '/admin/kefu/kefuConversation/chatVisitorTree')]
    #[Permission(code: 'kefu:kefuConversation:index')]
