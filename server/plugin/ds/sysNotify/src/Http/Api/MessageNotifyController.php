...
namespace Plugin\Ds\SysNotify\Http\Api;
...
use Plugin\Ds\SysNotify\Http\Api\Service\MessageNotifyService;
...
class MessageNotifyController extends AbstractController
{
     ...
     */
    #[Get(
        path: '/api/sysNotify/unread-statistics',
