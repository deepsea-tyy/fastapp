...
export function page(params: MessageNotifyVo): Promise<ResponseStruct<MessageNotifyVo[]>> {
  return useHttp().get('/admin/ds/sysNotify/message_notify/list', { params })
}

// 消息通知表新增
export function create(data: MessageNotifyVo): Promise<ResponseStruct<null>> {
  return useHttp().post('/admin/ds/sysNotify/message_notify/create', data)
}

// 消息通知表编辑
export function save(id: number, data: MessageNotifyVo): Promise<ResponseStruct<null>> {
  return useHttp().put(`/admin/ds/sysNotify/message_notify/save/${id}`, data)
}

// 消息通知表删除
export function deleteByIds(ids: number[]): Promise<ResponseStruct<null>> {
  return useHttp().delete('/admin/ds/sysNotify/message_notify/delete', { data: ids })
}