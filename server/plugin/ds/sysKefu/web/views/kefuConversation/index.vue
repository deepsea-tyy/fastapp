...
import { deleteByIds, page } from '$/ds/sysKefu/api/kefuConversation.ts'
...
defineOptions({ name: 'ds:sysKefu:kefuConversation' })
  ...
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['ds:sysKefu:kefuConversation:delete']"
          type="danger"
          plain
