...
import useWebSocketStore from '@/store/modules/useWebSocketStore'
        ...
        <div class="sidebar-header">
          ...
          <div class="header-connection-wrapper">
            <el-button
              ...
              size="small"
              circle
              :title="t('crud.refresh')"
              @click="handleRefreshConversations"
            >
              <ma-svg-icon name="mdi:refresh" :size="16" />
            </el-button>
            <el-tag :type="wsStore.wsConnected ? 'success' : 'danger'" size="small" style="margin-left: 8px">
              <ma-svg-icon
                :name="wsStore.wsConnected ? 'mdi:check-circle' : 'mdi:close-circle'"
                :size="14"
                style="margin-right: 4px"
              />
              {{ wsStore.wsConnected ? t('kefu.KefuChatFields.wsConnected') : t('kefu.KefuChatFields.wsDisconnected') }}
            </el-tag>
            <el-button
              v-if="wsStore.isMaxReconnectReached"
              type="primary"
              size="small"
              style="margin-left: 8px"
              @click="wsStore.manualReconnect"
            >
