...
import { deleteByIds, page } from '$/ds/sysNotify/api/messageNotify.ts'
...
defineOptions({ name: 'ds:sysNotify:message_notify' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['ds:sysNotify:message_notify:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['ds:sysNotify:message_notify:delete']"
          type="danger"
          plain
