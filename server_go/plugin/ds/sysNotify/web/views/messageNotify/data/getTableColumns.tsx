...
import { deleteByIds } from '$/ds/sysNotify/api/messageNotify.ts'
        ...
        actions: [
          {
            ...
            show: ({ row }) => showBtn('ds:sysNotify:message_notify:update', row),
            text: () => t('crud.edit'),
          ...
          {
            name: 'del',
            show: ({ row }) => showBtn('ds:sysNotify:message_notify:delete', row),
