...
import { deleteByIds, page } from '$/ds/syscms/api/feedComment.ts'
...
defineOptions({ name: 'ds:syscms:feed_comment' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['ds:syscms:feed_comment:create']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['ds:syscms:feed_comment:delete']"
          type="danger"
          plain
