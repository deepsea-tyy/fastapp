...
import { deleteByIds, page } from '$/ds/syscms/api/feedReport.ts'
...
defineOptions({ name: 'ds:syscms:feed_report' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['ds:syscms:feed_report:create']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['ds:syscms:feed_report:delete']"
          type="danger"
          plain
