...
interface MaEchartsExpose {
    echarts: echarts.ECharts;
    getInstance: echarts.ECharts;
    setOption: (options: echarts.EChartsOption, params?: OptionsParams[]) => void;
...
export type { Theme, ElementEventType, ElementEventName, MaEchartsExpose, Fn, RefValue, ComputedRefValue, MaEChartOptions, OptionsParams, AppendDataOpts, LoadingOpts, };
