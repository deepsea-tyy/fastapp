  ...
  setup() {
    ...
    const executeContextmenu = (e: MouseEvent, item: MineTabbar) => {
      ...
      ContextMenu.showContextMenu({
        ...
        items: [
          {
            label: t('base.tab.refresh') as string,
            icon: 'i-ri:refresh-line',
            onClick: async () => await tabStore.refreshTab(item),
          },
          {
            label: t('base.tab.close') as string,
                  ...
                  <ma-svg-icon
                    ...
                    onClick={(e: Event) => {
                      ...
                      if (item.name === tabStore.defaultTab.name) {
                        Message.error(t('base.tab.cannotUnfixed'))
                        return
                      }
