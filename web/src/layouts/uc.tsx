    ...
    const userinfoRender = () => (
      <div class="mine-uc-userinfo">
        <div class="flex items-center gap-x-3">
          {userInfo.avatar && <img src={formatImagePath(userInfo.avatar)} alt={userInfo.username} class="mine-uc-img-avatar" />}
        ...
        <m-tooltip text={useTrans('base.uc.backControl')}>
    ...
    return () => (
      <div class="mine-uc-container">
        <div class="mine-uc-aside hidden lg:block">
          <Logo title={useTrans('base.uc.title')} />
        ...
        <ul class="mine-uc-bottom-menu">
          ...
          <li>
            <router-link to={welcomeRoute.value}>
              ...
              <span>{useTrans('base.uc.shortBackControl')}</span>
            </router-link>
          </li>
        </ul>
      </div>
