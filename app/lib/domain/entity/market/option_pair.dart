...
class OptionPair {
  ...
  /// 标的资产符号
  final String? underlyingAssetSymbol;
  ...
  factory OptionPair.fromJson(Map<String, dynamic> json) {
    return OptionPair(
      ...
      underlyingAssetSymbol: json['underlying_asset_symbol'] as String?,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'underlying_asset_symbol': underlyingAssetSymbol,
  ...
  /// 是否看涨期权
  bool get isCallOption => optionType?.toLowerCase() == 'call';

  /// 是否看跌期权
  bool get isPutOption => optionType?.toLowerCase() == 'put';
}
