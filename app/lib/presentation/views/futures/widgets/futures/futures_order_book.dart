...
/// 期货订单簿组件
class FuturesOrderBook extends StatefulWidget {
  final double? formHeight;
  
  const FuturesOrderBook({super.key, this.formHeight});

  @override
  State<FuturesOrderBook> createState() => _FuturesOrderBookState();
}

class _FuturesOrderBookState extends State<FuturesOrderBook> {
