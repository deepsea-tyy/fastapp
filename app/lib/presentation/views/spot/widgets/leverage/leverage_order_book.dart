...
/// 杠杆订单簿组件
class LeverageOrderBook extends StatefulWidget {
  final double? formHeight;
  
  const LeverageOrderBook({super.key, this.formHeight});

  @override
  State<LeverageOrderBook> createState() => _LeverageOrderBookState();
}

class _LeverageOrderBookState extends State<LeverageOrderBook> {
