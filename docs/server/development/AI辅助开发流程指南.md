...
**核心文档**（必读）：
- [项目根目录 README](../../../README.md) - 项目说明和项目结构
- [开发规范](./开发规范.md) - 代码规范和开发模式
- [快速开始](../getting-started/快速开始.md) - 项目安装和基础配置

**功能文档**（按需阅读）：
- [代码生成器](../features/代码生成器.md) - 代码生成器使用方式
- [插件系统使用指南](../features/插件系统使用指南.md) - 插件开发方式
- [权限系统使用文档](../permission/权限系统使用文档.md) - 权限系统使用方式
