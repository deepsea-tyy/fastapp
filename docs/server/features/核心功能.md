...
详细文档请参考：
- [权限系统使用文档](../permission/权限系统使用文档.md) - 主文档
...
> 💡 **详细配置**：Swagger 完整配置说明请参考 [配置说明文档](../development/配置说明.md#6-swagger配置)
